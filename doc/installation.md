...
- Once booted, you can remove your USB. You will be prompted to **Start Setup** and setup your username and password among other things.
- Make sure to also enable third-party repositories during the setup. This will be required to install some software that might be proprietary but necessary for normal use.
